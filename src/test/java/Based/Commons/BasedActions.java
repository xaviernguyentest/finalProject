...
public class BasedActions {
	public void inputText(WebDriver driver, String xpath, String input, ExtentTest test) {
...
//		}
	...
	public void selectValue(WebDriver driver, String xpath, String value, ExtentTest test) {
...
//		}
	...
	public static String TakeScreenshot(WebDriver driver) throws IOException {
		...
		String destination = System.getProperty("user.dir") + File.separator + "my_report" + File.separator + "scr_"
				+ dateName + ".png";
...
//		return destination;
	...
	public void fluentWait(WebDriver driver, String xpath) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofMillis(10000)) // timeout = 10s
